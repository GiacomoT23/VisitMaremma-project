<?php  
    ...
    $esploraLaMaremmaDb = new EsploraLaMaremmaDbManager(); // creates a new istance of Database Class

	class EsploraLaMaremmaDbManager {
		private $mysqli_conn = null;
	
		function EsploraLaMaremmaDbManager(){
			$this->openConnection();
		}
