<?php
	...
	if (!isset($_GET['nomeLuogo']) || !isset($_GET['nomeUtente'])|| !isset($_GET['reviewToLoad'])|| !isset($_GET['offset'])){
	...
	$result1 = getPreviousReview($nomeLuogo, $nomeUtente);
	
	if (!checkEmptyResult($result1)){
		removeReview($nomeLuogo, $nomeUtente);
	}
		
	$result2 = getAllReviews($nomeLuogo, $offset, $reviewToLoad);
